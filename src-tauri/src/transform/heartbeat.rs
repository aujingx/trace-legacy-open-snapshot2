...
pub fn heartbeat(last_event: &TrackEvent, heartbeat: &TrackEvent, pulsetime_ms: i64) -> Option<TrackEvent> {
    // 1. 如果数据不同，不合并
...
impl HeartbeatManager {
    ...
    pub fn process_heartbeat(&mut self, bucket: &str, event: TrackEvent, pulsetime_ms: i64) -> HeartbeatResult {
...
mod tests {
    ...
    fn create_test_event(app: &str, title: &str, timestamp_ms: i64, duration_ms: i64) -> TrackEvent {
        TrackEvent {
            id: None,
            timestamp_ms,
            duration_ms,
